    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <form action="task.php" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="task_image" class="file-input">
        ...
        <div class="footer">
            <p>Desenvolvido por <a href="https://github.com/nandinhaaa">@nanda</a> e <a href="https://github.com/amxanda">@amanda</a></p>
        </div>
    </div>
